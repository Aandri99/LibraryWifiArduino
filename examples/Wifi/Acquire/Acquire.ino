/*
  Acquire data over WiFi example.

  Connects to a Red Pitaya over WiFi, configures a generator and
  acquisition, triggers immediately and reads captured samples.
